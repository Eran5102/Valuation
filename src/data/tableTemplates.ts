...
export const TABLE_TEMPLATES: TableTemplate[] = [
  // Cap Table Templates
  {
    ...
    sampleData: [
      { shareholder: 'Founder A', shareClass: 'Common', sharesOwned: 5000000, ownershipPercent: 0.45, liquidationValue: 4500000, fairValue: 4500000 },
      { shareholder: 'Founder B', shareClass: 'Common', sharesOwned: 3000000, ownershipPercent: 0.27, liquidationValue: 2700000, fairValue: 2700000 },
      { shareholder: 'Series A Investors', shareClass: 'Preferred A', sharesOwned: 2000000, ownershipPercent: 0.18, liquidationValue: 3000000, fairValue: 2500000 }
    ]
  },
  ...
  // Waterfall Analysis Templates
  {
    ...
    sampleData: [
      { scenario: 'Low Case', exitValue: 50000000, preferredReturn: 15000000, commonReturn: 20000000, managementReturn: 5000000, totalDistributed: 40000000 },
      { scenario: 'Base Case', exitValue: 100000000, preferredReturn: 20000000, commonReturn: 45000000, managementReturn: 10000000, totalDistributed: 75000000 },
      { scenario: 'High Case', exitValue: 200000000, preferredReturn: 25000000, commonReturn: 100000000, managementReturn: 20000000, totalDistributed: 145000000 }
    ]
  },
  ...
  // 409A Valuation Templates
  {
    ...
    sampleData: [
      { valuationDate: '2024-09-15', shareClass: 'Common', sharesOutstanding: 10000000, fairValuePerShare: 12.50, totalFairValue: 125000000, method: 'OPM' },
      { valuationDate: '2024-09-15', shareClass: 'Preferred A', sharesOutstanding: 2000000, fairValuePerShare: 15.00, totalFairValue: 30000000, method: 'OPM' }
    ]
  },
  ...
  // Comparable Company Analysis
  {
    ...
    sampleData: [
      { company: 'Company A', revenue: 500000000, ebitda: 75000000, enterpriseValue: 2500000000, evRevenue: 5.0, evEbitda: 33.3, marketCap: 2200000000 },
      { company: 'Company B', revenue: 300000000, ebitda: 60000000, enterpriseValue: 1800000000, evRevenue: 6.0, evEbitda: 30.0, marketCap: 1600000000 }
    ]
  },
  ...
  // Option Pricing Model Inputs
  {
    ...
    sampleData: [
      { parameter: 'Equity Value', value: '$125,000,000', source: 'DCF and Market Approaches', sensitivity: 'High' },
      { parameter: 'Volatility', value: '45%', source: 'Guideline Public Companies', sensitivity: 'Medium' },
      { parameter: 'Risk-Free Rate', value: '4.5%', source: '10-Year Treasury', sensitivity: 'Low' },
      { parameter: 'Time to Exit', value: '3.5 years', source: 'Management Projections', sensitivity: 'Medium' }
    ]
  },
  ...
  // DCF Model Summary
  {
    ...
    sampleData: [
      { year: 2024, revenue: 50000000, ebitda: 10000000, fcf: 5000000, discountFactor: 1.00, presentValue: 5000000, terminalValue: 0 },
      { year: 2025, revenue: 75000000, ebitda: 18000000, fcf: 12000000, discountFactor: 0.87, presentValue: 10440000, terminalValue: 0 },
      { year: 2026, revenue: 110000000, ebitda: 28000000, fcf: 20000000, discountFactor: 0.76, presentValue: 15200000, terminalValue: 0 },
      { year: 2027, revenue: 150000000, ebitda: 40000000, fcf: 30000000, discountFactor: 0.66, presentValue: 19800000, terminalValue: 85000000 }
    ]
  }
];
