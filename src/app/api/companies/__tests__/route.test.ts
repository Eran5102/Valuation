...
describe('/api/companies', () => {
  ...
  describe('GET /api/companies', () => {
    ...
    it('should apply pagination correctly', async () => {
      ...
      const request = createMockRequest('GET', 'http://localhost:3000/api/companies?page=2&limit=10');
      const response = await GET(request);
    ...
    it('should handle invalid pagination parameters', async () => {
      const request = createMockRequest('GET', 'http://localhost:3000/api/companies?page=0&limit=-1');
      const response = await GET(request);
  ...
  describe('POST /api/companies', () => {
    ...
    it('should create a new company successfully', async () => {
      ...
      const request = createMockRequest('POST', 'http://localhost:3000/api/companies', validCompanyData);
    ...
    it('should reject duplicate company names', async () => {
      ...
      const request = createMockRequest('POST', 'http://localhost:3000/api/companies', duplicateData);
      const response = await POST(request);
    ...
    it('should trim and validate optional fields', async () => {
      ...
      const request = createMockRequest('POST', 'http://localhost:3000/api/companies', dataWithOptionals);
      const response = await POST(request);
