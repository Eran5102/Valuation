    ...
    <AppLayout>
      <div className="space-y-6 p-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>How to use:</strong> Click on any field to copy its placeholder syntax to
            clipboard. You can then paste it into your template blocks using the format{' '}
            <code className="rounded bg-muted px-1">{'{{field_id}}'}</code>. Fields marked as
            "Required" should be included in your templates for complete 409A compliance.
          </AlertDescription>
        </Alert>
