...
describe('Cap Table Calculations', () => {
  ...
  describe('validateShareClass', () => {
    ...
    it('should validate shares outstanding', () => {
      ...
      expect(validateShareClass(invalidShareClass1)).toContain('Shares outstanding must be greater than 0');
      expect(validateShareClass(invalidShareClass2)).toContain('Shares outstanding must be greater than 0');
    });
    ...
    it('should validate participation cap for participating-with-cap', () => {
      ...
      const errors = validateShareClass(invalidShareClass);
      expect(errors).toContain('Participation cap is required for participating-with-cap preference type');
    });
