...
export type BlockType = 'text' | 'header' | 'paragraph' | 'table' | 'chart' | 'list' | 'pageBreak' | 'image' | 'separator' | 'quote' | 'dynamicTable' | 'breakpointsTable' | 'managementTable' | 'valuationSummary' | 'dateBlock';
