...
export function TemplateThemeManager({ template, onChange }: TemplateThemeManagerProps) {
  ...
  const applyTheme = useCallback((theme: TemplateTheme) => {
  ...
  const updateCustomTheme = useCallback((updates: Partial<TemplateTheme>) => {
    if (!customTheme) return;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Customize the visual appearance of your templates
          </p>
        </div>
        ...
        <TabsContent value="custom" className="space-y-6">
          {customTheme ? (
                ...
                <CardContent>
                  ...
                  >
                    ...
                    >
                      ...
                      The text uses the body font and text color from your theme.
                    </p>
                    <div
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold mb-2">Create Custom Theme</h3>
