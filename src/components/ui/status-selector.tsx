...
export function StatusSelector({ currentStatus, statusType, onStatusChange, disabled = false }: StatusSelectorProps) {
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute top-full mt-1 left-0 z-20 w-48 rounded-md border border-gray-200 bg-white shadow-lg">
            <div className="p-1">
              {statusOptions.map((option) => (
                <button
                  ...
                  disabled={isUpdating}
                  className={cn(
                    "w-full flex items-center space-x-2 rounded-sm px-2 py-1.5 text-sm text-left transition-colors",
