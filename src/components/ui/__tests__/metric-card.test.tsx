...
describe('MetricCard', () => {
  ...
  it('renders with description', () => {
    render(<MetricCard title="Total Sales" value={1500} description="Monthly revenue" />)
  ...
  it('renders with icon', () => {
    render(<MetricCard title="Growth" value={25} icon={TrendingUp} />)
  ...
  it('applies correct trend styling for upward trend', () => {
    render(<MetricCard title="Revenue" value={2000} trend="up" />)
  ...
  it('applies correct trend styling for downward trend', () => {
    render(<MetricCard title="Costs" value={500} trend="down" />)
  ...
  it('applies custom className', () => {
    render(<MetricCard title="Custom" value={50} className="custom-class" />)
