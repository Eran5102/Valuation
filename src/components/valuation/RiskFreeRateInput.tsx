      ...
      <div className="space-y-3">
          ...
          <div className="text-xs space-y-1">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>
                ...
                ({lastFetchResult.maturity})
                {lastFetchResult.interpolated && ' (interpolated)'}
              </span>
            </div>
            <div className="text-muted-foreground">
              Valuation Date: {lastFetchResult.valuationDate} | 
              Time to Liquidity: {lastFetchResult.timeToLiquidity} years
            </div>
          </div>
        )}
        ...
        {!canAutoFetch && (
          <div className="text-xs text-muted-foreground">
            💡 Set <strong>Valuation Date</strong> and <strong>Time to Liquidity</strong> to enable automatic yield curve fetching
          </div>
        )}
      </div>
    </TooltipProvider>
