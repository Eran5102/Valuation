...
export default function NormalizationAdjustments({
  years,
      ...
      <div className="space-y-6">
        ...
        {showForm && (
          <div className="space-y-4 rounded-md border p-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Affected Line Item</label>
              <Select
                onValueChange={(value) =>
                  setCurrentAdjustment((prev) => ({
                    ...prev,
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">Adjustment Amounts</label>
